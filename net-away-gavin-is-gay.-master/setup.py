...
NAME = 'net away gavin is gay."
AUTHOR = 'Hacker Anon'
AUTHOR_EMAIL = 'Nah bitch'
LICENSE = 'MIT'
VERSION = get_version()
URL = 'https://github.com/jjjjjjjjjjjjjjjjjjjjjjjjjjk/net-away-gavin-is-gay.'
DESCRIPTION = get_description()
KEYWORDS = ["SUSSY", "GET", "HACKED", "network"]
